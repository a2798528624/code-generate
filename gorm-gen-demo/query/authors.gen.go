...
import (
	...
	"go-code-generate/gorm-gen-demo/model"
)
...
func newAuthor(db *gorm.DB, opts ...gen.DOOption) author {
	...
	_author.Country = field.NewString(tableName, "country")
	_author.Age = field.NewInt32(tableName, "age")
...
func (a *author) updateTableName(table string) *author {
	...
	a.Age = field.NewInt32(table, "age")
